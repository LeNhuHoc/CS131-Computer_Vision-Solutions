...
def mix_images(image1, image2, channel1, channel2):
    ...
    out = None
    ### YOUR CODE HERE
    out_left=image1[:,0:150,:]
    out_right=image2[:,150:300,:]
    out_left=rgb_exclusion(out_left,channel1)
    out_right=rgb_exclusion(out_right,channel2)
...
def mix_quadrants(image):
    ...
    ### YOUR CODE HERE
    topleft=image[0:150,0:150,:]
    topright=image[0:150,150:300,:]
    bottomleft=image[150:300,0:150,:]
    bottomright=image[150:300,150:300,:]
    ...
    out_top = np.concatenate((topleft,topright),axis=1)
    out_bottom = np.concatenate((bottomleft,bottomright),axis=1)
    out=np.concatenate((out_top,out_bottom),axis=0)
    return out
    pass
    ### END YOUR CODE
